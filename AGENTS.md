# AI-ingest — project notes for Codex
...
- **The user drives all Git commands.** Codex prepares the work and explains each
...
- `gh` CLI is authed in Codex's environment but NOT the user's interactive terminal
  -> PRs are created via Codex and reviewed/merged on the GitHub website.
